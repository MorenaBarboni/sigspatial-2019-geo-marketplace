...
public class EthHelper {
    ...
    public static void prepareCredentials() {
        ...
        try {
            ...
            Credentials credentialsBuyer3 = Credentials.create("0xe485d098507f54e7733a205420dfddbe58db035fa577fc294ebd14db90767a52");
            Credentials credentialsBuyer4 = Credentials.create("0xa453611d9419d0e56f499079478fd72c37b251a94bfde4d19872c44cf65386e3");
            ...
            buyerAccounts.add(credentialsBuyer3);
            buyerAccounts.add(credentialsBuyer4);
            allCredentials.add(credentialsOwner);
            allCredentials.add(credentialsBuyer);
            allCredentials.add(credentialsBuyer2);
            allCredentials.add(credentialsBuyer3);
            allCredentials.add(credentialsBuyer4);
